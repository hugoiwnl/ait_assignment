...
if __name__ == '__main__':
    ...
    results_path = './results'  # Update this path
    data_path = './evaluation/HPatches'  # Update this path
    ...
    for seq in tqdm(seqs, 'sequences'):
        ...
        # Copy over the homography files using shutil.copy
        for h_file in h_files:
            src = os.path.join(data_path, seq, h_file)
            dst = os.path.join(seq_path, h_file)
            shutil.copy(src, dst)
        
        # Save detections as .npy files
